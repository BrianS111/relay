...
import { CardsThree } from '../../components/LandingCardsWithNav/CardData';
...
export default function index() {
  return (
    <Container>
      <H1>Oasis Borrow</H1>
      <P>
        Borrow Dai against your favorite crypto assets. Use the Dai however you
        like. Browse the featured, or select an asset to view our products.
      </P>
      <CardContainer>
